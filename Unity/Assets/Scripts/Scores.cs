...
public class Scores : MonoBehaviour {
    ...
    void Start () 
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            CreateLabel(offx + 80, offy + 110, 18, netman.Players[i].Name);
            CreateLabel(offx + 200, offy + 110, 18, "" + netman.Players[i].hittaken);
            CreateLabel(offx + 300, offy + 110, 18, "" + netman.Players[i].dmgnormal);
            CreateLabel(offx + 400, offy + 110, 18, "" + netman.Players[i].dmgweakpoint);
            CreateLabel(offx + 500, offy + 110, 18, "" + score);
            CreateLabel(offx + 600, offy + 110, 18, rank);
        }
    ...
    {
        string url = "http://www.dodsrv.com/crabbattle/scoresubmit.php";
