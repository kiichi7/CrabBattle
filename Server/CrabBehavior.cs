...
namespace CrabBattleServer
{
    ...
    class CrabBehavior
    {
        ...
        public CrabBehavior()
        {
            ...
            MaxHealth = 800 + 700 * Program.players.Count * Program.healthMod;
        ...
        public void UseCrabAction(Action crabAction)
        {
            ...
            if (crabAction.Id == (int)CrabActions.Walk)
            {
                ...
                Program.CrabAction(MovementActions[randomWalk].Id, ActionLength);
            }
            else
                Program.CrabAction(crabAction.Id, 1/actionMulti);
        ...
        {
            if (CurrentTarget == -1)
                CurrentTarget = Program.players[0].Id;
            ...
            if (TargetChange.ElapsedMilliseconds > changetick)
            {
                ...
                if (rnd == 0)
                {
                    ...
                    int prnd = random.Next(0, Program.players.Count);
                    CurrentTarget = Program.players[prnd].Id;
